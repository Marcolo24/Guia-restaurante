...
<div class="container mb-5">
    ...
    <form class="size" action="{{ route('restaurantes.store') }}" method="POST" enctype="multipart/form-data" id="createForm">
        @csrf
        <style>
...
input.error, select.error {
    border-color: red !important;
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nombre_restaurante" name="nombre" class="form-control" value="{{ old('nombre') }}" required onblur="validateNombre(this)">
            <div id="nombreError" class="error-message"></div>
        </div>

        <div class="mb-3">
            <label for="descripcion_restaurante" class="form-label">Descripción</label>
            <input type="text" id="descripcion_restaurante" name="descripcion" class="form-control" value="{{ old('descripcion') }}" required onblur="validateDescripcion(this)">
            <div id="descripcionError" class="error-message"></div>
        </div>

        <div class="mb-3">
            <label for="precio_medio_restaurante" class="form-label">Precio Medio</label>
            <input type="number" id="precio_medio_restaurante" name="precio_medio" class="form-control" value="{{ old('precio_medio') }}" required onblur="validatePrecio(this)">
            <div id="precioError" class="error-message"></div>
        </div>

        <div class="mb-3">
            <label for="direccion_restaurante" class="form-label">Dirección</label>
            <input type="text" id="direccion_restaurante" name="direccion" class="form-control" value="{{ old('direccion') }}" required onblur="validateDireccion(this)">
            <div id="direccionError" class="error-message"></div>
        </div>

        <div class="mb-3">
            <label for="telefono_restaurante" class="form-label">Teléfono</label>
            <input type="text" id="telefono_restaurante" name="telefono" class="form-control" value="{{ old('telefono') }}" required onblur="validateTelefono(this)">
            <div id="telefonoError" class="error-message"></div>
        </div>

        <div class="mb-3">
            <label for="web_restaurante" class="form-label">Sitio Web</label>
            <input type="text" id="web_restaurante" name="web" class="form-control" value="{{ old('web') }}" required onblur="validateWeb(this)">
